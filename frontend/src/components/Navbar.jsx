...
return (
<>
    <div className= {`container max-w-screen-2xl mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 ${
        ...
        <div className="navbar bg-base-100">
            ...
            <div className="navbar-end space-x-3">
                ...
                <div className='hidden md:block'>
                    <label className=" border flex items-center gap-2 rounded-md px-3 py-2">
                ...
                <div>
                    ...
                    <a
                        className="bg-black text-white px-3 py-2 rounded-md hover:bg-zinc-700 duration-200 cursor-pointer">Login</a>
                </div>
            </div>
        </div>
    </div>
